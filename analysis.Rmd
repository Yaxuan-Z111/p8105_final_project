...
+ \beta_1 \cdot \text{SEX_A} + \beta_2 \cdot \text{AGEP_A} + \beta_3 \cdot \text{WEIGHTLBTC_A} + \beta_4 \cdot \text{HEIGHTTC_A} \\
+ \beta_5 \cdot \text{DIFF_A} + \beta_6 \cdot \text{EDUCP_A} + \beta_7 \cdot \text{LSATIS4_A} + \beta_8 \cdot \text{PHSTAT_A} + \beta_9 \cdot \text{CHLEV_A} \\
+ \beta_{10} \cdot \text{HYPEV_A} + \beta_{11} \cdot \text{LIVEREV_A} + \beta_{12} \cdot \text{STREV_A} + \beta_{13} \cdot \text{MIEV_A} + \beta_{14} \cdot \text{ANGEV_A} \\
+ \beta_{15} \cdot \text{CHDEV_A} + \beta_{16} \cdot \text{DEPEV_A} + \beta_{17} \cdot \text{ANXEV_A} + \beta_{18} \cdot \text{SMKEV_A} + \beta_{19} \cdot \text{LONELY_A}
$$
