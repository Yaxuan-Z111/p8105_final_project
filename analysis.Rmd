...
=======
model_results_tidy = tidy(glm_model, conf.int = TRUE) |>
>>>>>>> 34f3a2c59c8b25458854e9ad7928c28c8faa8846
>>>>>>> 33d1fa37086654d8e6ed30628456089f80fd3e50
  mutate(
    Beta = estimate,
    OR = exp(estimate),
...
```{r}
### Build Model without confounder
...
```{r}
model_formula <- DIBEV_A ~ WEIGHTLBTC_A + HEIGHTTC_A + 
...
### Model Results compared with the regional one
